...
% Extracting engine parameters
pause(2);
inputeng = inputdlg({'Cylinder Bore Diameter (mm)','Cylinder Stroke length(mm)','No. of Cylinders(s)'},'ENGINE PARAMETERS',[1 50; 1 50; 1 50]);
